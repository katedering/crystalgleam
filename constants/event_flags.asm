...
; Johto story events
	...
	const EVENT_GOT_PIKACHU_FROM_BILL
...
; Crystal Gleam
	...
	const EVENT_LISTENED_TO_BILL_QUESTION
	const EVENT_GOT_EEVEE_FROM_BILL
	const EVENT_GOT_EON_STONE_FROM_LALA
	const EVENT_USED_CHEAT_CLUB
; experimental
	const EVENT_HEARD_ABOUT_GLITCH
	const EVENT_MISSINGNO
	const EVENT_POKEMON_MANSION_B1F_OLD_KEY
	const EVENT_GOT_BOTH_POKEMON_FROM_BILL
