...
SongInfo:
	...
	song_info "SV Area Zero", ORIGIN_SV, COMPOSER_TOBY_FOX_GO_ICHINOSE, COMPOSER_NONE
	song_info "DPPT Fight Area", ORIGIN_DPPT, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
	song_info "DPPT Fight Area     Night", ORIGIN_DPPT, COMPOSER_JUNICHI_MASUDA_GO_ICHINOSE, COMPOSER_TRITEHEXAGON
