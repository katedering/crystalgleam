...
OddEggs:
	...
	db THUNDERSHOCK, CHARM, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp CLEFFA, IS_EGG_MASK | PLAIN_FORM
	db TACKLE, CHARM, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp IGGLYBUFF, IS_EGG_MASK | PLAIN_FORM
	db SING, CHARM, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp TYROGUE, IS_EGG_MASK | PLAIN_FORM
	db METRONOME, RAGE, FORESIGHT, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp SMOOCHUM, IS_EGG_MASK | PLAIN_FORM
	db TACKLE, LICK, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp ELEKID, IS_EGG_MASK | PLAIN_FORM
	db QUICK_ATTACK, LEER, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp MAGBY, IS_EGG_MASK | PLAIN_FORM
	db HAZE, LEER, DIZZY_PUNCH, METRONOME
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp MIME_JR_, IS_EGG_MASK | PLAIN_FORM
	db BARRIER, CONFUSION, METRONOME, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality
	...
	db METRONOME, WATER_GUN, GROWL, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality
